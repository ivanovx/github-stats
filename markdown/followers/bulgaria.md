...
The `number of followers` of users in Bulgaria on `2024/11/19 4:54 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
