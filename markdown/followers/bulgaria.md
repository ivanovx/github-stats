...
The `number of followers` of users in Bulgaria on `2024/11/19 2:12 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

There are `1 countries` and `5 cities` can be found [here](https://github.com/ivanovx/top-gh-users).
